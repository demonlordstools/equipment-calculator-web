...
const units: Array<Unit> = [
    ...
    unit('Teufel', UnitType.UNDEAD, 520, false, Element.NONE, 90, 1000, 1400, 1500, 0),
    unit('Ifrit', UnitType.UNDEAD, 360, false, Element.FIRE, 210, 1930, 3000, 2550, 0),
    unit('Daktyle', UnitType.DEMON, 250, false, Element.NONE, 100, 1000, 775, 1050, 300),
    ...
    unit('Eiselementar', UnitType.ELEMENTAL, 200, false, Element.ICE, 50, 1570, 1170, 1240, 300),
